...
# Read data
df <- read.csv("https://raw.githubusercontent.com/emilbrodersen/Statistical-Programming-Languages/master/balancedTrain.csv",
               sep = ",")
...
# Save the model
setwd("C:\\Users\\Emil\\Desktop\\Statistical Programming Languages\\Bank Telemarketing")
save(nn, file = "nn_prediction_balanced.rda")
